...
class OrderCreateAfterListener implements ListenerInterface
{
    ...
    {
        [$order, $group, $uid, $key, $combinationId] = $event;
        ...
        $orderCreate->orderCreateAfter($order, $group, $combinationId);
        ...
        //订单自动取消
        $this->pushJob($order['id'], $combinationId);
     ...
     * @return mixed
     */
    public function pushJob(int $orderId, int $combinationId = 0)
    {
        //系统预设取消订单时间段
