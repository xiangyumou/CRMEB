...
/**
 * `/api/v1/site/config` — 站点公开配置 (CR-7-h2).
 *
 * Public, like the agreements read: every one of the six legacy calls it
 * replaces happens before there is a session — on launch, above the sign-in
