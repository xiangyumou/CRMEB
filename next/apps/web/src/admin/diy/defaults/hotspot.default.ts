import type { HotspotComponent } from '@shop/contracts/diy/schema/hotspot.schema';

/**
 * Factory default for `hotspot` — 热区.
 *
...
} as unknown as HotspotComponent;
