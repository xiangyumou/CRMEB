import type { RichTextComponent } from '@shop/contracts/diy/schema/richText.schema';

/**
 * Factory default for `richText` — 富文本.
 *
 * Copied from `template/admin/src/components/mobilePage/z_ueditor.vue`,
