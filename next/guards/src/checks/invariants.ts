...
import { invariantsDoc, nextRoot, rel, repoRoot, uniApp } from '../lib/paths';
import {
  closest,
  isTestModule,
  mentions,
 ...
 *      the file read relative to `next/` first and to the repository root
 *      second (the deploy rehearsal lives outside the workspace). A test file
...
const TEST_ROOTS = [nextRoot, uniApp];
