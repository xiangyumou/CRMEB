...
export const STREAM_STATE: Readonly<Record<string, StreamState>> = {
  ...
  R1: 'merged', // reliability: CR-53/50/51/40/41/23-k2, STAB-001
  ...
  R7: 'merged', // ETL complete: wire shipping/cms/wechat-oa/notification, add groupbuy/presale, --require-complete in the drill
};
