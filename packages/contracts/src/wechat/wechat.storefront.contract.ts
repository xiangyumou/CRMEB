 ...
 * signed-in shopper sharing something (a product poster, a 拼团 invite, a 预售
 * card), the call costs a WeChat quota, and an anonymous endpoint that makes an
 * upstream request per hit is a free amplifier. A visitor who has not signed in
 * sees the share button after the sign-in sheet.
 *
...
export const wechatMiniCode = defineRoute({
  ...
  // RATE_LIMITED: more than 30 *new* codes in an hour for one account; a code
  // somebody already generated is always free.
